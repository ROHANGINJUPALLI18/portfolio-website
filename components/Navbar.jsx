    ...
    <nav className="bg-[#222831]">
      ...
      <div className="h-16 items-center flex justify-around ">
        ...
        <div className="hidden sm:block">
          <Link href="/" className={handleNavItemClick("/")}>
            About
          </Link>
          <Link
            href="/Experience"
            className={handleNavItemClick("/Experience")}
          >
            Experience
          </Link>
          <Link href="/Skills" className={handleNavItemClick("/Skills")}>
            Skills
          </Link>
          <Link href="/Projects" className={handleNavItemClick("/Projects")}>
            Projects
          </Link>
          {session?.user && (
            <Link href="/Contact" className={handleNavItemClick("/Contact")}>
              Contact
            </Link>
          )}
        </div>
        ...
        <CiMenuBurger
          ...
          className="block sm:hidden text-3xl text-white"
        />
      </div>
      {/* mobile buttons/links */}
      <div
        ref={menuRef}
        className={`${isOpen ? "block" : "hidden"} sm:hidden space-y-2 pb-3 rounded-2xl border border-black/30 shadow-lg bg-[#40534C] p-2 `}
      >
        <Link
          href="/"
          onClick={() => closeMenu()}
          className="text-white-600 text-lg px-4 block"
        >
          About Me
        </Link>
        <Link
